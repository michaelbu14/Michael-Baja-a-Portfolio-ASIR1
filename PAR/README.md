...
**Impacto Profesional:** Las VLANs son el pilar del diseño de red moderno para reducir dominios de broadcast. Saber aislar tráfico lógicamente desde la línea de comandos es esencial en cualquier arquitectura.
...
**El Reto y Ejecución:** Análisis del proceso de resolución de direcciones (ARP). Se manipularon las tablas de caché introduciendo entradas físicas estáticas falsificadas para simular un ataque de "Envenenamiento ARP" (Spoofing), interceptando y bloqueando exitosamente la comunicación entre clientes de la misma subred.
